export default function showValidationError(name: string) {
  switch (name) {
    ...
    case 'display_name':
      return 'латиница или кириллица, без цифр, нет спецсимволов, не больше 50 знаков';
    case 'login':
      return 'от 3 до 20 символов, латиница, может содержать цифры, без пробелов и спецсимволов (кроме - и _)';
    case 'email':
